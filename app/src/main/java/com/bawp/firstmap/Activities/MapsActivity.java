...
import com.bawp.firstmap.setting;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < Constants.LIMIT; i++) {
                                ...
                                // we amke random function so that we are getting different marker color
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()) {
            ...
            case R.id.exit:
                ...
                return(true);
            case R.id.showList:
                startActivity(new Intent(getApplicationContext(), QuakesListActivity.class));
                return (true);
...
//private LatLng alps=new LatLng(47.368955,9.702579);
   ...
   // private ArrayList<MarkerOptions> markerArrayList;
     ...
     */
        ...
        markeralps=new MarkerOptions()
        .position(alps)
        .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN))
        .title("alps");
        markerArrayList.add(markeralps);
        markersydney=new MarkerOptions()
        .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE))
        .title("sydney")
        .position(sydney);
        markerArrayList.add(markersydney);
